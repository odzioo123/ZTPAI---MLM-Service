...
export default function LoginLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="flex justify-center items-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('/back1.png')" }}>
            <div className="bg-gray-100 shadow-md rounded flex flex-col md:flex-row max-w-4xl p-6 space-y-6 md:space-y-0 md:space-x-6">
                <div className="md:w-1/2 p-6 bg-green-500 rounded flex flex-col items-center justify-center">
